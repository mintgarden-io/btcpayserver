...
using BTCPayServer.Services.Altcoins.Chia;
#endif
namespace BTCPayServer.Hosting
{
    public static class BTCPayServerServices
    {
        ...
        public static IServiceCollection AddBTCPayServer(this IServiceCollection services, IConfiguration configuration, Logs logs)
        {
            ...
            if (configuration.SupportChain("xch"))
                services.AddChiaLike();
#endif
        ...
        internal static void RegisterRateSources(IServiceCollection services)
        {
            ...
            services.AddRateProviderExchangeSharp<ExchangeHuobiAPI>(new("huobi", "HTX", "https://api.huobi.pro/market/tickers"));
